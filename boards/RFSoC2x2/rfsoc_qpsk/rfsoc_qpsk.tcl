...
proc create_hier_cell_qpsk_tx { parentCell nameHier } {
  ...
  connect_bd_net -net reset_1 [get_bd_pins resetn] [get_bd_pins clk_tx/resetn]
...
proc create_hier_cell_qpsk_rx { parentCell nameHier } {
  ...
  connect_bd_net -net resetn_1 [get_bd_pins resetn] [get_bd_pins clk_rx/resetn]
  connect_bd_net -net xlconcat_0_dout [get_bd_pins xlconcat_0/dout] [get_bd_pins s2mm_introut]
...
proc create_root_design { parentCell } {
  ...
  set_property CONFIG.CONST_VAL {0} $lmk_reset_low
...
\
  ...
  connect_bd_intf_net -intf_net qpsk_tx_M_AXIS [get_bd_intf_pins qpsk_tx/M_AXIS] [get_bd_intf_pins usp_rf_data_converter_0/s00_axis]
  ...
  connect_bd_net -net lmk_reset_low_dout [get_bd_pins lmk_reset_low/dout] [get_bd_ports lmk_reset]
  ...
  connect_bd_net -net qpsk_tx_clk_out_128 [get_bd_pins qpsk_tx/clk_out_128] [get_bd_pins usp_rf_data_converter_0/s0_axis_aclk]
  connect_bd_net -net qpsk_tx_ready [get_bd_pins qpsk_tx/ready] [get_bd_pins pl_leds_concat/In0]
  connect_bd_net -net qpsk_tx_reset_128 [get_bd_pins qpsk_tx/reset_128] [get_bd_pins usp_rf_data_converter_0/s0_axis_aresetn]
  connect_bd_net -net resetn_0_1 [get_bd_ports reset] [get_bd_pins qpsk_rx/resetn] [get_bd_pins qpsk_tx/resetn]
  ...
  connect_bd_net -net usp_rf_data_converter_0_clk_adc0 [get_bd_pins usp_rf_data_converter_0/clk_adc0] [get_bd_pins qpsk_rx/adc_clk_64]
  connect_bd_net -net usp_rf_data_converter_0_clk_dac0 [get_bd_pins usp_rf_data_converter_0/clk_dac0] [get_bd_pins qpsk_tx/dac_clk_128]
