...
proc create_hier_cell_interpolate_logic { parentCell nameHier } {
  ...
  connect_bd_net -net reset_128_1 [get_bd_pins reset_128] [get_bd_pins axis_data_fifo_0/m_axis_aresetn] [get_bd_pins axis_data_fifo_1/m_axis_aresetn]
...
proc create_hier_cell_decimate_logic { parentCell nameHier } {
  ...
  create_bd_pin -dir I -type clk clk_out2
  ...
  # Create port connections
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins clk_out1] [get_bd_pins axis_data_fifo_0/s_axis_aclk] [get_bd_pins axis_data_fifo_1/s_axis_aclk] [get_bd_pins fir_compiler_0/aclk] [get_bd_pins fir_compiler_1/aclk]
  connect_bd_net -net clk_wiz_1_clk_out1 [get_bd_pins clk_out2] [get_bd_pins axis_data_fifo_0/m_axis_aclk] [get_bd_pins axis_data_fifo_1/m_axis_aclk]
  connect_bd_net -net reset_128_peripheral_aresetn [get_bd_pins s_axis_aresetn] [get_bd_pins axis_data_fifo_0/s_axis_aresetn] [get_bd_pins axis_data_fifo_1/s_axis_aresetn]
  connect_bd_net -net rst_usp_rf_data_converter_0_62M1_peripheral_aresetn [get_bd_pins m_axis_aresetn] [get_bd_pins axis_data_fifo_0/m_axis_aresetn] [get_bd_pins axis_data_fifo_1/m_axis_aresetn]
...
proc create_hier_cell_qpsk_tx { parentCell nameHier } {
  ...
  create_bd_pin -dir O -from 0 -to 0 -type rst reset_25_6
  ...
  connect_bd_intf_net -intf_net axi_qpsk_tx_m_rf_axis [get_bd_intf_pins axi_qpsk_tx/m_rf_axis] [get_bd_intf_pins interpolate_logic/S_AXIS]
  ...
  connect_bd_net -net clk_128_clk_out1 [get_bd_pins clk_out_128] [get_bd_pins clk_128/clk_out1] [get_bd_pins clk_256/clk_in1] [get_bd_pins interpolate_logic/clk_128] [get_bd_pins reset_128/slowest_sync_clk]
  ...
  connect_bd_net -net clk_dac_1 [get_bd_pins dac_clk_64] [get_bd_pins clk_128/clk_in1]
  connect_bd_net -net dac0_bufg_BUFG_O [get_bd_pins clk_out_25_6] [get_bd_pins axi_dma_fft/m_axi_s2mm_aclk] [get_bd_pins axi_dma_fft/s_axi_lite_aclk] [get_bd_pins axi_dma_symbol/m_axi_s2mm_aclk] [get_bd_pins axi_dma_symbol/s_axi_lite_aclk] [get_bd_pins axi_dma_time/m_axi_s2mm_aclk] [get_bd_pins axi_dma_time/s_axi_lite_aclk] [get_bd_pins axi_qpsk_tx/clk] [get_bd_pins axi_smc_1/aclk] [get_bd_pins clk_256/clk_out1] [get_bd_pins interpolate_logic/clk_25_6] [get_bd_pins ps8_0_axi_periph/M00_ACLK] [get_bd_pins ps8_0_axi_periph/M02_ACLK] [get_bd_pins ps8_0_axi_periph/M03_ACLK] [get_bd_pins ps8_0_axi_periph/M04_ACLK] [get_bd_pins reset_25_6/slowest_sync_clk]
  connect_bd_net -net reset_1 [get_bd_pins reset] [get_bd_pins clk_128/reset] [get_bd_pins clk_256/reset]
  connect_bd_net -net reset_128_peripheral_aresetn [get_bd_pins reset_128] [get_bd_pins interpolate_logic/reset_128] [get_bd_pins reset_128/peripheral_aresetn]
  ...
  connect_bd_net -net rst_dac0_bufg_0M_peripheral_aresetn [get_bd_pins reset_25_6] [get_bd_pins axi_dma_fft/axi_resetn] [get_bd_pins axi_dma_symbol/axi_resetn] [get_bd_pins axi_dma_time/axi_resetn] [get_bd_pins axi_qpsk_tx/axi_qpsk_tx_aresetn] [get_bd_pins ps8_0_axi_periph/M00_ARESETN] [get_bd_pins ps8_0_axi_periph/M02_ARESETN] [get_bd_pins ps8_0_axi_periph/M03_ARESETN] [get_bd_pins ps8_0_axi_periph/M04_ARESETN] [get_bd_pins reset_25_6/peripheral_aresetn]
...
proc create_hier_cell_qpsk_rx { parentCell nameHier } {
  ...
  connect_bd_intf_net -intf_net axis_data_fifo_0_M_AXIS [get_bd_intf_pins axi_qpsk_rx/s_i_axis] [get_bd_intf_pins decimate_logic/M_AXIS1]
  connect_bd_intf_net -intf_net axis_data_fifo_1_M_AXIS [get_bd_intf_pins axi_qpsk_rx/s_q_axis] [get_bd_intf_pins decimate_logic/M_AXIS]
  ...
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins clk_128] [get_bd_pins clk_128/clk_out1] [get_bd_pins clk_256/clk_in1] [get_bd_pins decimate_logic/clk_out1] [get_bd_pins reset_128/slowest_sync_clk]
  connect_bd_net -net clk_wiz_1_clk_out1 [get_bd_pins clk_25_6] [get_bd_pins axi_dma_rx/m_axi_s2mm_aclk] [get_bd_pins axi_dma_rx/s_axi_lite_aclk] [get_bd_pins axi_dma_rx_dec/m_axi_s2mm_aclk] [get_bd_pins axi_dma_rx_dec/s_axi_lite_aclk] [get_bd_pins axi_dma_rx_rrc/m_axi_s2mm_aclk] [get_bd_pins axi_dma_rx_rrc/s_axi_lite_aclk] [get_bd_pins axi_dma_rx_sync/m_axi_s2mm_aclk] [get_bd_pins axi_dma_rx_sync/s_axi_lite_aclk] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/M01_ACLK] [get_bd_pins axi_interconnect_0/M02_ACLK] [get_bd_pins axi_interconnect_0/M03_ACLK] [get_bd_pins axi_interconnect_0/M04_ACLK] [get_bd_pins axi_qpsk_rx/clk] [get_bd_pins clk_256/clk_out1] [get_bd_pins decimate_logic/clk_out2] [get_bd_pins reset_256/slowest_sync_clk] [get_bd_pins smartconnect_0/aclk]
  connect_bd_net -net reset_1 [get_bd_pins reset] [get_bd_pins clk_128/reset] [get_bd_pins clk_256/reset]
  connect_bd_net -net reset_128_peripheral_aresetn [get_bd_pins reset_128] [get_bd_pins decimate_logic/s_axis_aresetn] [get_bd_pins reset_128/peripheral_aresetn]
  connect_bd_net -net reset_256_peripheral_aresetn [get_bd_pins axi_dma_rx/axi_resetn] [get_bd_pins axi_dma_rx_dec/axi_resetn] [get_bd_pins axi_dma_rx_rrc/axi_resetn] [get_bd_pins axi_dma_rx_sync/axi_resetn] [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins axi_interconnect_0/M01_ARESETN] [get_bd_pins axi_interconnect_0/M02_ARESETN] [get_bd_pins axi_interconnect_0/M03_ARESETN] [get_bd_pins axi_interconnect_0/M04_ARESETN] [get_bd_pins axi_qpsk_rx/axi_qpsk_rx_aresetn] [get_bd_pins decimate_logic/m_axis_aresetn] [get_bd_pins reset_256/peripheral_aresetn] [get_bd_pins smartconnect_0/aresetn]
  connect_bd_net -net usp_rf_data_converter_0_clk_adc0 [get_bd_pins adc_clk_64] [get_bd_pins clk_128/clk_in1]
  connect_bd_net -net xlconcat_0_dout [get_bd_pins s2mm_introut] [get_bd_pins xlconcat_0/dout]
