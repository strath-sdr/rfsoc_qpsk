...
\
  ...
  connect_bd_intf_net -intf_net axis_broadcaster_M00_AXIS [get_bd_intf_pins axis_broadcaster/M00_AXIS] [get_bd_intf_pins qpsk_rx/s_i_axis]
  connect_bd_intf_net -intf_net axis_broadcaster_M01_AXIS [get_bd_intf_pins axis_broadcaster/M01_AXIS] [get_bd_intf_pins qpsk_rx/s_q_axis]
  ...
  connect_bd_intf_net -intf_net usp_rf_data_converter_0_m10_axis [get_bd_intf_pins axis_broadcaster/S_AXIS] [get_bd_intf_pins usp_rf_data_converter_0/m10_axis]
  ...
  # Create port connections
  connect_bd_net -net adc_clk_64_1 [get_bd_pins usp_rf_data_converter_0/clk_adc1] [get_bd_pins qpsk_rx/adc_clk_64]
  ...
  connect_bd_net -net proc_sys_reset_128M_peripheral_aresetn [get_bd_pins proc_sys_reset_128M/peripheral_aresetn] [get_bd_pins usp_rf_data_converter_0/s1_axis_aresetn]
  connect_bd_net -net qpsk_rx_clk_128 [get_bd_pins qpsk_rx/clk_128] [get_bd_pins axis_broadcaster/aclk] [get_bd_pins usp_rf_data_converter_0/m1_axis_aclk]
  connect_bd_net -net qpsk_rx_clk_out2 [get_bd_pins qpsk_rx/clk_25_6] [get_bd_pins zynq_ultra_ps_e_0/saxihp1_fpd_aclk]
  connect_bd_net -net qpsk_rx_reset_128 [get_bd_pins qpsk_rx/reset_128] [get_bd_pins axis_broadcaster/aresetn] [get_bd_pins usp_rf_data_converter_0/m1_axis_aresetn]
  ...
  connect_bd_net -net usp_rf_data_converter_0_clk_dac1 [get_bd_pins usp_rf_data_converter_0/clk_dac1] [get_bd_pins proc_sys_reset_128M/slowest_sync_clk] [get_bd_pins usp_rf_data_converter_0/s1_axis_aclk]
  ...
  connect_bd_net -net zynq_ultra_ps_e_0_pl_resetn0 [get_bd_pins zynq_ultra_ps_e_0/pl_resetn0] [get_bd_pins qpsk_rx/pl_reset] [get_bd_pins qpsk_tx/pl_reset] [get_bd_pins proc_sys_reset_128M/ext_reset_in] [get_bd_pins rst_ps8_0_99M/ext_reset_in]
