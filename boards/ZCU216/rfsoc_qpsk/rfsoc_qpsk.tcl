...
proc create_hier_cell_qpsk_tx { parentCell nameHier } {
  ...
  connect_bd_net -net dac0_bufg_BUFG_O [get_bd_pins clk_out_25_6] [get_bd_pins axi_smc_1/aclk] [get_bd_pins clk_tx/clk_out1] [get_bd_pins dma_tx_fft/m_axi_s2mm_aclk] [get_bd_pins dma_tx_fft/s_axi_lite_aclk] [get_bd_pins dma_tx_symbol/m_axi_s2mm_aclk] [get_bd_pins dma_tx_symbol/s_axi_lite_aclk] [get_bd_pins dma_tx_time/m_axi_s2mm_aclk] [get_bd_pins dma_tx_time/s_axi_lite_aclk] [get_bd_pins interpolate_logic/clk_25_6] [get_bd_pins ps8_0_axi_periph/M00_ACLK] [get_bd_pins ps8_0_axi_periph/M02_ACLK] [get_bd_pins ps8_0_axi_periph/M03_ACLK] [get_bd_pins ps8_0_axi_periph/M04_ACLK] [get_bd_pins qpsk_tx/clk] [get_bd_pins reset_25_6/slowest_sync_clk]
...
proc create_hier_cell_qpsk_rx { parentCell nameHier } {
  ...
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins clk_128] [get_bd_pins clk_rx/clk_out1] [get_bd_pins decimate_logic/clk_128] [get_bd_pins reset_128/slowest_sync_clk] [get_bd_pins smartconnect_0/aclk1]
...
proc create_root_design { parentCell } {
  ...
  # Create port connections
  connect_bd_net -net adc_clk_64_1 [get_bd_pins qpsk_rx/adc_clk_64] [get_bd_pins usp_rf_data_converter_0/clk_adc1]
  ...
  connect_bd_net -net qpsk_rx_clk_128 [get_bd_pins axis_broadcaster/aclk] [get_bd_pins qpsk_rx/clk_128] [get_bd_pins usp_rf_data_converter_0/m1_axis_aclk]
  connect_bd_net -net qpsk_rx_clk_out2 [get_bd_pins qpsk_rx/clk_25_6] [get_bd_pins zynq_ultra_ps_e_0/saxihp1_fpd_aclk]
  connect_bd_net -net qpsk_rx_reset_128 [get_bd_pins axis_broadcaster/aresetn] [get_bd_pins qpsk_rx/reset_128] [get_bd_pins usp_rf_data_converter_0/m1_axis_aresetn]
  ...
  connect_bd_net -net usp_rf_data_converter_0_clk_dac1 [get_bd_pins proc_sys_reset_128M/slowest_sync_clk] [get_bd_pins usp_rf_data_converter_0/clk_dac1] [get_bd_pins usp_rf_data_converter_0/s1_axis_aclk]
  connect_bd_net -net usp_rf_data_converter_0_clk_dac2 [get_bd_pins qpsk_tx/dac_clk_128] [get_bd_pins usp_rf_data_converter_0/clk_dac2]
  ...
  connect_bd_net -net zynq_ultra_ps_e_0_pl_resetn0 [get_bd_pins proc_sys_reset_128M/ext_reset_in] [get_bd_pins qpsk_rx/pl_reset] [get_bd_pins qpsk_tx/pl_reset] [get_bd_pins rst_ps8_0_99M/ext_reset_in] [get_bd_pins zynq_ultra_ps_e_0/pl_resetn0]
