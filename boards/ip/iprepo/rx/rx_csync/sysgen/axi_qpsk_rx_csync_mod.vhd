...
entity axi_qpsk_rx_csync_stub is
  port (
...
end axi_qpsk_rx_csync_stub;
architecture structural of axi_qpsk_rx_csync_stub is 
begin
  sysgen_dut : entity xil_defaultlib.axi_qpsk_rx_csync_0 
  port map (
