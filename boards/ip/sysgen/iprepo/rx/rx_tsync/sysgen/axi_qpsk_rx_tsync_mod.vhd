...
entity axi_qpsk_rx_tsync_stub is
  port (
...
end axi_qpsk_rx_tsync_stub;
architecture structural of axi_qpsk_rx_tsync_stub is 
begin
  sysgen_dut : entity xil_defaultlib.axi_qpsk_rx_tsync_0 
  port map (
