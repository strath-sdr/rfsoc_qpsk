-- Generated from Simulink block Determine Frequency Correction Term
library IEEE;
...
begin
  ...
  generic map (
    ...
    c_width => 19,
    latency => 1,
    mem_init_file => "xpm_288ad8_vivado.mem",
    mem_size => 9728,
    mem_type => "block",
    read_reset_val => "0"
  )
...
-- Generated from Simulink block CORDIC vector magnitude1
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
...
-- Generated from Simulink block Scaled Mag Squared FFT
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
...
-- Generated from Simulink block Coarse Frequency Synchroniser
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
...
begin
  ...
  delay2_q_net <= i_samples;
  delay1_q_net <= q_samples;
  ...
  port map (
    ...
    s_axis_data_tvalid => delay1_q_net_x1(0),
    s_axis_data_tlast => delay1_q_net_x1(0),
  ...
  product : entity xil_defaultlib.xlaxi_qpsk_rx_csync_cmpy_v6_0_i0_152106942e580a70937a347604186697 
  port map (
    a_re => delay2_q_net,
    a_im => delay1_q_net,
    b_re => delay2_q_net,
  ...
  product1 : entity xil_defaultlib.xlaxi_qpsk_rx_csync_cmpy_v6_0_i1_7cee748c1baeb2f328794d1f881a2e3c 
  port map (
