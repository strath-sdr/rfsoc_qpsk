...
typedef struct {
    ...
    axi_qpsk_rx_rrc_uio_map maps[ MAX_UIO_MAPS ];
} axi_qpsk_rx_rrc_uio_info;

/***************** Variable Definitions **************************************/
static axi_qpsk_rx_rrc_uio_info uio_info;
...
static int uio_info_read_name(axi_qpsk_rx_rrc_uio_info* info) {
