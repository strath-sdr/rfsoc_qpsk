...
begin
  ...
  mcode : entity xil_defaultlib.sysgen_mcode_block_064f6fcd79 
  port map (
    clr => '0',
...
begin
  ...
  tvalid_out <= register4_q_net;
  tlast_out <= register3_q_net;
  mux1_y_net <= time_i_data;
  delay_hb1_q_net <= time_i_valid;
  mux1_y_net_x0 <= time_q_data;
  delay_hb1_q_net_x0 <= time_q_valid;
  slice8_y_net <= reset;
  packetsizetime_net <= packet_size;
  slice10_y_net <= transfer;
  slice9_y_net <= auto_restart;
...
architecture structural of axi_qpsk_tx_post_hb_fft is 
  ...
  signal mux1_y_net_x1 : std_logic_vector( 32-1 downto 0 );
...
begin
  ...
  tvalid_out <= register4_q_net;
  tlast_out <= register3_q_net;
  mux1_y_net <= post_hb_i_data;
  delay_hb1_q_net_x0 <= post_hb_i_valid;
  mux1_y_net_x0 <= post_hb_q_data;
  delay_hb1_q_net <= post_hb_q_valid;
  slice7_y_net <= reset;
  packetsizefft_net <= packet_size;
  ...
  constant1 : entity xil_defaultlib.sysgen_constant_fab097cb51 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  port map (
    en => '1',
    rst => '1',
    d => delay_hb1_q_net_x0,
    clk => src_clk_net,
    ce => we_ce_net,
    q => delay_q_net
  );
  fft : entity xil_defaultlib.xlaxi_qpsk_tx_xfft_v9_1_i0_fd8bca78edfadbd22aa432a764c9b22b_wrapper 
  port map (
    in_re => convert1_dout_net,
    in_im => convert2_dout_net,
    start_frame_in => mux_y_net,
    clk => src_clk_net,
    ce => we_ce_net,
    op_re => fft_op_re_net,
    op_im => fft_op_im_net,
  ...
  mux : entity xil_defaultlib.sysgen_mux_695c2c1342 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
    sel => delay_hb1_q_net_x0,
    d0 => constant1_op_net,
...
begin
  ...
  lfsr : entity xil_defaultlib.sysgen_lfsr_bd334bbaa5 
  port map (
    clr => '0',
    rst => slice1_y_net,
    en => logical1_y_net,
  ...
  lfsr1 : entity xil_defaultlib.sysgen_lfsr_ff541ddb11 
  port map (
    clr => '0',
    rst => slice1_y_net,
    en => logical1_y_net,
...
begin
  ...
  register2_q_net_x0 <= symbol_i_valid;
...
architecture structural of axi_qpsk_tx_txinterp_i is 
  ...
  signal register2_q_net_x0 : std_logic_vector( 1-1 downto 0 );
  signal reinterpret_output_port_net_x0 : std_logic_vector( 32-1 downto 0 );
  signal counter_op_net : std_logic_vector( 32-1 downto 0 );
  signal logical_y_net : std_logic_vector( 1-1 downto 0 );
  signal logical1_y_net : std_logic_vector( 1-1 downto 0 );
...
begin
  ...
  slice1_y_net <= reset;
  down_sample1_q_net <= tready;
  register2_q_net_x0 <= tvalid_in;
  packetsizerf_net <= packetsize;
  reinterpret_output_port_net_x0 <= outputgainstage;
  ...
  delay_cic1 : entity xil_defaultlib.sysgen_delay_b9d6a69b2f 
  port map (
    clr => '0',
  ...
  delay_cic2 : entity xil_defaultlib.sysgen_delay_1abcf9bc04 
  port map (
    clr => '0',
  ...
  delay_ciccomp1 : entity xil_defaultlib.sysgen_delay_099499c6da 
  port map (
    clr => '0',
  ...
  delay_hb1 : entity xil_defaultlib.sysgen_delay_1abcf9bc04 
  port map (
    clr => '0',
    d => upsample_hb_q_net,
  ...
  delay_rrc2 : entity xil_defaultlib.sysgen_delay_99fb475ca4 
  port map (
    clr => '0',
...
begin
  ...
  m_fft_axis_tdata <= register5_q_net_x0;
  m_fft_axis_tlast <= register3_q_net_x2;
  m_fft_axis_tready_net <= m_fft_axis_tready;
  m_fft_axis_tvalid <= register4_q_net_x1;
  m_symbol_axis_tdata <= convert4_dout_net;
  m_symbol_axis_tlast <= register3_q_net_x0;
  m_symbol_axis_tready_net <= m_symbol_axis_tready;
  m_symbol_axis_tvalid <= register4_q_net;
  m_time_axis_tdata <= register5_q_net;
  m_time_axis_tlast <= register3_q_net_x1;
  m_time_axis_tready_net <= m_time_axis_tready;
  m_time_axis_tvalid <= register4_q_net_x0;
  clk_net <= clk_1;
  ce_net_x1 <= ce_1;
  clk_3200_net <= clk_3200;
  ce_3200_net <= ce_3200;
...
architecture structural of axi_qpsk_tx is 
  ...
  attribute core_generation_info of structural : architecture is "axi_qpsk_tx,sysgen_core_2018_2,{,compilation=IP Catalog,block_icon_display=Default,family=zynquplusRFSOC,part=xczu28dr,speed=-2-e,package=ffvg1517,synthesis_language=vhdl,hdl_library=xil_defaultlib,synthesis_strategy=Vivado Synthesis Defaults,implementation_strategy=Vivado Implementation Defaults,testbench=0,interface_doc=0,ce_clr=0,clock_period=39.0625,system_simulink_period=3.90625e-08,waveform_viewer=1,axilite_interface=1,ip_catalog_plugin=0,hwcosim_burst_mode=0,simulation_time=1,abs=2,addsub=1,cic_compiler_v4_0=2,cmult=3,concat=4,constant=13,convert=25,counter=7,delay=27,dsamp=1,fifo=3,fir_compiler_v7_2=6,inv=11,lfsr=2,logical=21,mcode=3,mult=4,mux=12,register=19,reinterpret=10,relational=12,shift=4,slice=13,usamp=40,xfft_forward=1,}";
